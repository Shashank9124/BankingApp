...
const Deposit = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!hasTransactionPin) {
            setError('Please set your transaction PIN before making a deposit.');
            setIsLoading(false);
            return;
        }
        ...
        try {
            const res = await API.post('/transactions/deposit', { amount: parseFloat(amount), transactionPin, accountNumber: selectedAccount });
            ...
            <div className="transaction-card">
                ...
                {!hasTransactionPin && (
                    <div className="alert alert-warning">
                        You need to <Link to="/set-transaction-pin">set your Transaction PIN</Link> before making deposits.
                    </div>
                )}
